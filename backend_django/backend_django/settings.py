...
SECRET_KEY = 'django-insecure-18wdxtv!=&cwkxgf%&tdruo%gr390_h-0p@$q56@dkr120f^_o'
...
DJOSER = {
    'SERIALIZERS': {
        'user_create': 'users.serializers.user.UserRegistrationSerializer',
        'current_user': 'users.serializers.user.CurrentUserSerializer'
    },
    'LOGIN_FIELD': 'email',
